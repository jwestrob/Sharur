...
from bennu.predicates.evaluator import evaluate_predicate
from bennu.predicates.vocabulary import PREDICATE_BY_ID
...
def search_by_predicates(
    ...
    Returns:
        BennuResult with matching proteins
    """
    has = has or []
    lacks = lacks or []
...
def _format_search_results(
    ...
    """Format search results into BennuResult."""
