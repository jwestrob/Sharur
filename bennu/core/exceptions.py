"""
Custom exceptions for Bennu.

All Bennu-specific exceptions inherit from BennuError.
"""


class BennuError(Exception):
    """Base exception for all Bennu errors."""
...
class VectorStoreError(BennuError):
