"""
Reference report template for Sharur analyses.
...
class SharurReport(FPDF):
    ...
    def __init__(self, theme: str = "default", title: str = "Sharur Analysis Report"):
        super().__init__()
    ...
    def footer(self):
        ...
        self.cell(0, 10, 'Generated by Sharur Metagenomic Analysis System', 0, 0, 'C')
...
def generate_report_from_manifest(
    ...
    pdf = SharurReport(theme=theme, title=f"{dataset_name} Analysis")
    ...
    pdf.body_text("""
Analysis performed using Sharur metagenomic analysis framework.
