...
MOBILE_PREDICATES = [
    ...
    PredicateVocab("rm_type_i", "R-M Type I", "Type I restriction-modification system", "mobile", "restriction_modification"),
    PredicateVocab("rm_type_ii", "R-M Type II", "Type II restriction-modification system", "mobile", "restriction_modification"),
    PredicateVocab("rm_type_iii", "R-M Type III", "Type III restriction-modification system", "mobile", "restriction_modification"),
    PredicateVocab("rm_type_iv", "R-M Type IV", "Type IV restriction-modification system", "mobile", "restriction_modification"),
    PredicateVocab("rm_type_iig", "R-M Type IIG", "Type IIG restriction-modification system", "mobile", "restriction_modification"),
    PredicateVocab("abi_alpha", "AbiAlpha", "AbiAlpha abortive infection system", "mobile", "abortive_infection"),
    PredicateVocab("abi_e", "AbiE", "AbiE abortive infection system", "mobile", "abortive_infection"),
    PredicateVocab("abi_j", "AbiJ", "AbiJ abortive infection system", "mobile", "abortive_infection"),
    PredicateVocab("abi_l", "AbiL", "AbiL abortive infection system", "mobile", "abortive_infection"),
    PredicateVocab("abi_p2", "AbiP2", "AbiP2 abortive infection system", "mobile", "abortive_infection"),
    PredicateVocab("abi_u", "AbiU", "AbiU abortive infection system", "mobile", "abortive_infection"),
    PredicateVocab("abi_v", "AbiV", "AbiV abortive infection system", "mobile", "abortive_infection"),
    PredicateVocab("abi_z", "AbiZ", "AbiZ abortive infection system", "mobile", "abortive_infection"),
    PredicateVocab("psyrta", "PsyrTA", "PsyrTA toxin-antitoxin defense system", "mobile", "toxin_antitoxin"),
    PredicateVocab("rosmerta", "RosmerTA", "RosmerTA toxin-antitoxin defense system", "mobile", "toxin_antitoxin"),
    PredicateVocab("shosta", "ShosTA", "ShosTA toxin-antitoxin defense system", "mobile", "toxin_antitoxin"),
    PredicateVocab("defense_acriii1", "AcrIII1", "AcrIII1 defense system", "mobile", "defense_system"),
    PredicateVocab("defense_apyc1", "Apyc1", "Apyc1 defense system", "mobile", "defense_system"),
    PredicateVocab("defense_atd", "ATD", "ATD defense system", "mobile", "defense_system"),
    PredicateVocab("defense_avs", "Avs", "Avs defense system", "mobile", "defense_system"),
    PredicateVocab("defense_borvo", "Borvo", "Borvo defense system", "mobile", "defense_system"),
    PredicateVocab("defense_caprel", "CapRel", "CapRel defense system", "mobile", "defense_system"),
    PredicateVocab("defense_ceres", "Ceres", "Ceres defense system", "mobile", "defense_system"),
    PredicateVocab("defense_dctp_deaminase", "dCTP deaminase", "dCTP deaminase defense system", "mobile", "defense_system"),
    PredicateVocab("defense_ds", "DS", "DS-family defense system", "mobile", "defense_system"),
    PredicateVocab("defense_eleos", "Eleos", "Eleos defense system", "mobile", "defense_system"),
    PredicateVocab("defense_esos", "Esos", "Esos defense system", "mobile", "defense_system"),
    PredicateVocab("defense_gabija", "Gabija", "Gabija defense system", "mobile", "defense_system"),
    PredicateVocab("defense_gcu142", "gcu142", "gcu142 defense system", "mobile", "defense_system"),
    PredicateVocab("defense_hachiman", "Hachiman", "Hachiman defense system", "mobile", "defense_system"),
    PredicateVocab("defense_hec", "HEC", "HEC defense system", "mobile", "defense_system"),
    PredicateVocab("defense_hma", "Hma", "Hma defense system", "mobile", "defense_system"),
    PredicateVocab("defense_kiwa", "Kiwa", "Kiwa defense system", "mobile", "defense_system"),
    PredicateVocab("defense_lamassu", "Lamassu", "Lamassu defense system", "mobile", "defense_system"),
    PredicateVocab("defense_lit", "Lit", "Lit defense system", "mobile", "defense_system"),
    PredicateVocab("defense_mokosh", "Mokosh", "Mokosh defense system", "mobile", "defense_system"),
    PredicateVocab("defense_nlr", "NLR-like", "NLR-like defense system", "mobile", "defense_system"),
    PredicateVocab("defense_pago", "pAgo", "Prokaryotic Argonaute defense system", "mobile", "defense_system"),
    PredicateVocab("defense_pd_lambda", "PD-Lambda", "Phage-derived PD-Lambda defense system", "mobile", "defense_system"),
    PredicateVocab("defense_pd_t4", "PD-T4", "Phage-derived PD-T4 defense system", "mobile", "defense_system"),
    PredicateVocab("defense_pd_t7", "PD-T7", "Phage-derived PD-T7 defense system", "mobile", "defense_system"),
    PredicateVocab("defense_prometheus", "Prometheus", "Prometheus defense system", "mobile", "defense_system"),
    PredicateVocab("defense_prrc", "PrrC", "PrrC defense system", "mobile", "defense_system"),
    PredicateVocab("defense_retron", "Retron", "Retron defense system", "mobile", "defense_system"),
    PredicateVocab("defense_rloc", "RloC", "RloC defense system", "mobile", "defense_system"),
    PredicateVocab("defense_shedu", "Shedu", "Shedu defense system", "mobile", "defense_system"),
    PredicateVocab("defense_sofic", "SoFic", "SoFic defense system", "mobile", "defense_system"),
    PredicateVocab("defense_tiamat", "Tiamat", "Tiamat defense system", "mobile", "defense_system"),
    PredicateVocab("defense_toutatis", "Toutatis", "Toutatis defense system", "mobile", "defense_system"),
