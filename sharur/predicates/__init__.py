...
For topology predictions (requires sharur[topology]):
...
from sharur.predicates.registry import (
    PredicateDefinition,
    PredicateRegistry,
    get_registry,
)
from sharur.predicates.evaluator import (
    evaluate_predicate,
